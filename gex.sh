...
# Write bot code to qilkbot.js BEFORE initializing project
cat > "$BOT_FILE" << 'EOF'
...
# Initialize Node.js project in current directory
npm init -y

# Install dependencies
npm install mineflayer prismarine-viewer mineflayer-pathfinder node-fetch@2

echo "✅ Bot code written to $BOT_FILE"
echo "Run the bot with: node $BOT_FILE"